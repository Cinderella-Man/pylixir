defmodule Pylixir.RuntimeHelpers do
  ...
  #
  # Pattern strings come in raw (matching Python's `r'...'` literal
  # convention used in competitive code). We compile at runtime via
  # `Regex.compile!/1` — Python's regex syntax is close enough to PCRE
  # that the common patterns work unchanged. Returned shapes mirror
  # Python: list-of-strings for findall, string|nil for search/match,
  # rewritten string for sub.
